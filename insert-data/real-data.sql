...
insert into work_place (id, city, street) values ( (select coalesce(max(id),0)+1 from work_place), 'London', 'Rathbone Square' ); 
...
insert into jobs (role_id, employee, location_id, job_id, starting_date, ending_date) values ( (select max(id) from roles), (select max(id) from people), (select max(id) from work_place) , (select coalesce(max(job_id),0)+1 from jobs), to_date('201906', 'YYYYMM'), to_date('201910', 'YYYYMM'));
...
insert into work_place (id, city, street) values ( (select coalesce(max(id),0)+1 from work_place), 'Chicago', 'Monroe Street' ); 
...
insert into jobs (role_id, employee, location_id, job_id, starting_date, ending_date) values ( (select max(id) from roles), (select max(id) from people), (select max(id) from work_place) , (select coalesce(max(job_id),0)+1 from jobs), to_date('201906', 'YYYYMM'), to_date('202007', 'YYYYMM'));
...
insert into work_place (id, city, street) values ( (select coalesce(max(id),0)+1 from work_place), 'Cracow', 'Pawia' ); 
insert into companies (id, name, main_country) values ( (select coalesce(max(id),0)+1 from companies), 'Qualtrics ', 'USA');
insert into roles (role_id, role_name, company_id) values ( (select coalesce(max(role_id),0)+1 from roles), 'Software Engineer', (select max(id) from companies) );
insert into jobs (role_id, employee, location_id, job_id, starting_date, ending_date) values ( (select max(id) from roles), (select max(id) from people), (select max(id) from work_place) , (select coalesce(max(job_id),0)+1 from jobs), to_date('202101', 'YYYYMM'), NULL);
...
insert into work_place (id, city, street) values ( (select coalesce(max(id),0)+1 from work_place), 'Cracow', 'Jana Pawła II' ); 
...
insert into jobs (role_id, employee, location_id, job_id, starting_date, ending_date) values ( (select max(id) from roles), (select max(id) from people), (select max(id) from work_place) , (select coalesce(max(job_id),0)+1 from jobs), to_date('202010', 'YYYYMM'), NULL);
...
insert into jobs (role_id, employee, location_id, job_id, starting_date, ending_date) values ( (select max(id) from roles), (select max(id) from people), (select max(id) from work_place) , (select coalesce(max(job_id),0)+1 from jobs), to_date('202010', 'YYYYMM'), to_date('202101', 'YYYYMM'));
...
insert into roles (role_id, role_name, company_id) values ( (select coalesce(max(role_id),0)+1 from roles), 'Software Developer', (select max(id) from companies) );
insert into work_place (id, city, street) values ( (select coalesce(max(role_id),0)+1 from work_place), 'Cracow', 'Olszańska' )
insert into jobs (role_id, employee, location_id, job_id, starting_date, ending_date) values ( (select max(id) from roles), (select max(id) from people), (select max(id) from work_place) , (select coalesce(max(job_id),0)+1 from jobs), to_date('201804', 'YYYYMM'), to_date('201905', 'YYYYMM'));
